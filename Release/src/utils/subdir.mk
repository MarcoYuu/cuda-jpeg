...
src/utils/%.o: ../src/utils/%.cpp
	...
	nvcc -I/usr/local/include/opencv -I../ -I../~/Library/boost -I../~/Library/ -I../~/NVIDIA_GPU_Computing_SDK/shared/inc -O3 -gencode arch=compute_20,code=sm_21 -odir "src/utils" -M -o "$(@:%.o=%.d)" "$<"
	nvcc -I/usr/local/include/opencv -I../ -I../~/Library/boost -I../~/Library/ -I../~/NVIDIA_GPU_Computing_SDK/shared/inc -O3 --compile  -x c++ -o  "$@" "$<"
...
src/utils/%.o: ../src/utils/%.cu
	...
	@echo 'Invoking: nvcc compiler'
	nvcc -I/usr/local/include/opencv -I../ -I../~/Library/boost -I../~/Library/ -I../~/NVIDIA_GPU_Computing_SDK/shared/inc -O3 -gencode arch=compute_20,code=sm_21 -odir "src/utils" -M -o "$(@:%.o=%.d)" "$<"
	nvcc --device-c -I/usr/local/include/opencv -I../ -I../~/Library/boost -I../~/Library/ -I../~/NVIDIA_GPU_Computing_SDK/shared/inc -O3 -gencode arch=compute_20,code=sm_21  -x cu -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
