...
/* ジグザグシーケンス用 */
/************************/
__device__ __constant__ static const int	kZigzagT[64] = {
	0,  1,  5,  6, 14, 15, 27, 28,
...
/******************/
// ファイル出力、内部処理兼用
__device__ __constant__ static const int	kYQuantumT[] = {					// 輝度用
...
__device__ __constant__ static const int	kCQuantumT[] = {					// 色差用
