...
//============================================================================
	...
	UtilCVImage* p_cvimg_src = utilCV_LoadImage("Lena512.bmp", UTIL_CVIM_COLOR);
...
//============================================================================
	...
	utilCV_SaveImage("out_cpu.bmp", p_cvimg_dst);
...
//============================================================================
	...
	utilCV_SaveImage("out_gpu.bmp", p_cvimg_dst);
